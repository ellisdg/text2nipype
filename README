...
## Introduction
NipypeGPT requires an OpenAI API key to run. You can get one [here](https://platform.openai.com/).
...
The path to the workflow file can be specified with the `--workflow_file` argument.
